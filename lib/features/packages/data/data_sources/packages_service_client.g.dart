...
part of 'packages_service_client.dart';
...
class _PackagesServiceClient implements PackagesServiceClient {
  _PackagesServiceClient(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<PackagesResponse> getPackages(String lang) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PackagesResponse>(
  ...
  @override
  Future<MySubscriptionsResponse> getMySubscriptions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MySubscriptionsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MySubscriptionsResponse _value;
    try {
      _value = MySubscriptionsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<PaymentInfoResponse> getPaymentInfo() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaymentInfoResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/payment-info',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaymentInfoResponse _value;
    try {
      _value = PaymentInfoResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<SubscribeResponse> subscribe(int packageId) async {
    ...
    _data.fields.add(MapEntry('package_id', packageId.toString()));
