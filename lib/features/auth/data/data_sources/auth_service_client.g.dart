...
class _AuthServiceClient implements AuthServiceClient {
  _AuthServiceClient(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<DeleteAccountResponse> deleteAccount(String password) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
  ...
  Future<UpdatePasswordResponse> updatePassword(
    ...
    _data.fields.add(MapEntry('password', password));
    _data.fields.add(MapEntry('password_confirmation', passwordConfirmation));
    final _options = _setStreamType<UpdatePasswordResponse>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
